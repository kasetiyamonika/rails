...
class OrderProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_product" do
    assert_difference('OrderProduct.count') do
      post order_products_url, params: { order_product: { discount: @order_product.discount, discount_type: @order_product.discount_type, order_id: @order_product.order_id, price: @order_product.price, product_id: @order_product.product_id, total: @order_product.total } }
    end
  ...
  test "should update order_product" do
    patch order_product_url(@order_product), params: { order_product: { discount: @order_product.discount, discount_type: @order_product.discount_type, order_id: @order_product.order_id, price: @order_product.price, product_id: @order_product.product_id, total: @order_product.total } }
