...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { address: @table.address, name: @table.name, number: @table.number } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { address: @table.address, name: @table.name, number: @table.number } }
