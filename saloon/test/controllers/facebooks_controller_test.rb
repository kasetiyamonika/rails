...
class FacebooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facebook" do
    assert_difference('Facebook.count') do
      post facebooks_url, params: { facebook: { hobby: @facebook.hobby, name: @facebook.name, number: @facebook.number } }
    end
  ...
  test "should update facebook" do
    patch facebook_url(@facebook), params: { facebook: { hobby: @facebook.hobby, name: @facebook.name, number: @facebook.number } }
